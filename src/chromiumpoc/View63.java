...
public class View63 extends ViewPart {
	public static final String ID = "chromium-poc.view63";
	...
	public void createPartControl(Composite parent) {
		...
		URL url = FileLocator.find(bundle, Path.fromPortableString("resources/poc63.html"), null);
		try {
